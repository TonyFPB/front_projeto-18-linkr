...
export default function UserSearch({mobile})
{
                            ...
                            resultsPeople.length !== 0 &&
                                                        <SearchResults>
                                                            <ul>
                                                                ...
                                                                {
                                                                    resultsPeople.map( (r) => {
                                                                                                return(<li key={r.id} onClick={ (e) => searchPeopleByid(r.id)}>
                                                                                                            <img src={r.image} />
                                                                                                            {r.name}
                                                                                                        </li>
                                                                                                        )
    ...
    return(<>
                ...
                (mobile === true) ?
                                    <StyledSearchTimeline>
                                        ...
                                        <DebounceInput
                                            ...
                                            value={name}
                                            // type="name"
                                            onChange={(e) => { nameSearch = e.target.value; searchPeople(nameSearch) }}
                                            onKeyUp={(e) => nameSearch = e.target.value }
                                            onKeyPress={ (e) => { if(e.key === 'Enter') { nameSearch = e.target.value; searchPeople(nameSearch) } }}
                                        />
        ...
        {
           (mobile === true) ?  resultsPeople.length !== 0 &&
                                        <SearchResultsMobile>
                                            <ul>
